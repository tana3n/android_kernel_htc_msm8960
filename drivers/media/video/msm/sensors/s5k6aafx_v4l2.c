			     ...
			     const struct i2c_device_id *id)
{
	...
	// ***ADD***
	pr_info("000000");
	rc = msm_sensor_i2c_probe(s5k6aafx_client, s5k6aafx_i2c_id);
	pr_info("111111");
	if (rc >= 0) {
		pr_info("22222222222");
		s5k6aafx_sysfs_init();
...
static int __s5k6aafx_probe(struct platform_device *pdev)
{
	...
	//return msm_sensor_register(s5k6aafx_sensor_probe_cb);
	//pr_info("111");
	//s5k6aafx_sensor_probe_cb;
	//pr_info("222");
	return 0;
}
...
{
//	struct msm_camera_sensor_info *sinfo = s5k6aafx_pdev->dev.platform_data;
//	struct msm_sensor_ctrl *s = NULL;

//	return platform_driver_register(&msm_camera_driver);
	pr_info("fuga cam");
//	s5k6aafx_sensor_probe(sinfo, s);
return i2c_add_driver(&s5k6aafx_i2c_driver);
	pr_info("hage cam");
//	return 0;
//return platform_driver_register(&msm_camera_driver);

//	s5k6aafx_sensor_probe(NULL, NULL, NULL);
//	pr_info("aaaaaa");
	return 0;
}
